 ...
 * ## The snapshot
 *
 * 133 runtime names from `packages/common/src/index.ts`, measured at `737b`-era HEAD `db7371f`:
 *
 *     node --import tsx -e \
 ...
 * 133 identifiers manually would have produced a snapshot of my typing rather than of the code.
 */
